            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="valid_from" name="valid_from" value="{{ $voucher->valid_from }}">
                    </div>
                    <div class="form-group">
                        <label for="valid_until">Ngày Kết Thúc</label>
                        <input type="date" class="form-control" id="valid_until" name="valid_until" value="{{ $voucher->valid_until }}">
                    </div>
